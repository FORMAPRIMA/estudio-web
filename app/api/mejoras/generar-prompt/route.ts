...
- Modo cliente: botón de ojo abierto/cerrado en la cabecera del warehouse (components/team/memorias-calidad/ModoClienteToggle.tsx + useModoCliente, sessionStorage). Oculta coste, margen y eliminar; el PVP se llama "Precio" (sin IVA / con IVA)
