...
import { crearEspacioCore } from '@/lib/espacio/create'
...
// enviarCorreoBienvenida y crearEspacioCore viven en '@/lib/espacio/create'
// (server-only, reutilizado por el flujo público del formulario web).
