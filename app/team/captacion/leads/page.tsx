...
export default async function Page() {
  ...
  const [{ data: leads }, { data: espacios }, { data: propuestas }, { data: contratos }] = await Promise.all([
    admin
      .from('leads')
    ...
    admin
      .from('contratos')
      .select('id, numero, status, lead_id, cliente_id, propuesta_id, fecha_envio, fecha_firma, created_at')
      .order('created_at', { ascending: false }),
  ])
