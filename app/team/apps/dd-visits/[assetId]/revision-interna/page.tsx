...
import DdRevisionInterna from '@/components/team/dd-visits/DdRevisionInterna'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Revisión Interna' }

export default async function RevisionInternaPage({ params }: { params: { assetId: string } }) {
