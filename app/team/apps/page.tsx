  ...
  return (
    <div style={{ padding: '40px 48px', maxWidth: 900 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
        ...
        {canAccessControlObra(profile.rol, user.email) && (
          <Link href="/team/apps/control-obra" style={{ textDecoration: 'none' }}>
            ...
            >
              ...
              <p style={{ fontSize: 11, color: '#1A1A1A70', fontWeight: 300, lineHeight: 1.5, marginBottom: 20 }}>
                Control económico de obra: baseline congelado, cambios sobre presupuesto, proveedores, pagos, tesorería y vista cliente.
              </p>
              <span style={{
                fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase',
                color: '#D85A30', fontWeight: 500,
        ...
        <Link href="/team/apps/repasos" style={{ textDecoration: 'none' }}>
          <div
            className="apps-card"
            style={{
              background: '#fff',
          ...
          >
            ...
            <p style={{ fontSize: 11, color: '#1A1A1A70', fontWeight: 300, lineHeight: 1.5, marginBottom: 20 }}>
              Repasos marcados sobre el plano con foto, oficio y estado. Enlaces de solo lectura para constructora y cliente.
            </p>
            <span style={{
              fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase',
              color: '#D85A30', fontWeight: 500,
