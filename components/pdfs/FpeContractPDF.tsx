...
//
// Build constraint:
//   @react-pdf/renderer ships ESM with top-level await. If imported statically
//   here, webpack/Terser fails on the server bundle ("await isn't allowed in
//   non-async function"). All uses of the package live inside the async
//   generateFpeContractPDF function so the module graph stays sync.
//
// DocuSign anchors preserved from the previous implementation
// (see lib/docusign/client.ts):
...
// ══════════════════════════════════════════════════════════════════════════════
// Helpers (no @react-pdf/renderer references — safe at module level)
// ══════════════════════════════════════════════════════════════════════════════
...
// ── Palette (no react-pdf references) ─────────────────────────────────────────
const C = {
  headerBg: '#1A1A1A',
  brand:    '#D85A30',
  ink:      '#1A1A1A',
...
// ══════════════════════════════════════════════════════════════════════════════
// Main wrapper — all @react-pdf/renderer usage lives inside this closure.
// ══════════════════════════════════════════════════════════════════════════════

/**
 * Generates the "Orden de Ejecución de Obra para Execution Partner" PDF.
...
export async function generateFpeContractPDF(data: FpeContractData): Promise<Buffer> {
  ...
  const s = StyleSheet.create({
    ...
    // Cover header
    coverHeader: { backgroundColor: C.headerBg, paddingTop: 36, paddingBottom: 0, paddingHorizontal: 56 },
    coverHeaderInner: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 18 },
    coverLogo: { width: 130, height: 'auto' },
    coverTitle: { color: C.hInk, fontSize: 13, fontFamily: 'Helvetica-Bold', letterSpacing: 3, textTransform: 'uppercase', textAlign: 'right' },
    coverSubtitle: { color: C.brand, fontSize: 8.5, fontFamily: 'Helvetica-Bold', letterSpacing: 2, textTransform: 'uppercase', textAlign: 'right', marginTop: 6 },
    coverRef: { color: C.hMid, fontSize: 8, marginTop: 8, textAlign: 'right' },
    coverAccent: { height: 2, backgroundColor: C.brand, opacity: 0.85 },
    // Compact header
    compactHeader: { backgroundColor: C.headerBg, paddingTop: 20, paddingBottom: 14, paddingHorizontal: 56, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    compactLogo: { width: 88, height: 'auto' },
    compactRight: { flexDirection: 'column', alignItems: 'flex-end' },
    compactTitle: { color: C.hInk, fontSize: 8.5, fontFamily: 'Helvetica-Bold', letterSpacing: 2, textTransform: 'uppercase' },
    ...
    // Meta strip
    metaBar: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 56, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: C.rule },
    ...
    // Section title
    sectionTitle: { fontSize: 7.5, fontFamily: 'Helvetica-Bold', letterSpacing: 1.8, textTransform: 'uppercase', color: C.brand, paddingTop: 18, paddingBottom: 7, borderBottomWidth: 1, borderBottomColor: C.rule, marginBottom: 12 },
    // Parties
    partiesRow: { flexDirection: 'row', gap: 12 },
    partyCard: { flex: 1, padding: 12, backgroundColor: C.light, borderLeftWidth: 2, borderLeftColor: C.brand },
    partyLabel: { fontSize: 6.5, fontFamily: 'Helvetica-Bold', color: C.meta, letterSpacing: 1.4, textTransform: 'uppercase', marginBottom: 6 },
    ...
    // Executive summary
    summaryGrid: { backgroundColor: C.light, paddingVertical: 10, paddingHorizontal: 4, marginBottom: 6 },
    summaryRow: { flexDirection: 'row' },
    summaryCell: { flex: 1, paddingHorizontal: 12, paddingVertical: 6, borderLeftWidth: 1, borderLeftColor: C.rule },
    summaryCellFirst: { flex: 1, paddingHorizontal: 12, paddingVertical: 6 },
    ...
    totalBand: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: C.headerBg, paddingVertical: 12, paddingHorizontal: 18, marginTop: 10 },
    ...
    clauseNumber: { fontSize: 6.5, fontFamily: 'Helvetica-Bold', color: C.brand, letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 2 },
    clauseTitle: { fontSize: 9, fontFamily: 'Helvetica-Bold', color: C.ink, marginBottom: 4 },
    clauseText: { fontSize: 8.5, color: C.soft, lineHeight: 1.55, marginBottom: 4 },
    clauseListItem: { fontSize: 8.5, color: C.soft, lineHeight: 1.55, marginLeft: 14, marginBottom: 2 },
    // Anexos
    anexoIntro: { fontSize: 8.5, color: C.soft, lineHeight: 1.55, paddingVertical: 4, paddingHorizontal: 10, borderLeftWidth: 2, borderLeftColor: C.brand, backgroundColor: C.light, marginBottom: 12 },
    anexoClose: { fontSize: 7.5, color: C.mid, lineHeight: 1.55, marginTop: 14, paddingTop: 10, borderTopWidth: 1, borderTopColor: C.rule, fontFamily: 'Helvetica-Oblique' },
    // Tables
    tHead: { flexDirection: 'row', backgroundColor: C.headerBg, paddingVertical: 7, paddingHorizontal: 8 },
    th: { fontSize: 6.5, fontFamily: 'Helvetica-Bold', color: '#C8C5BF', letterSpacing: 0.8, textTransform: 'uppercase' },
    tRow: { flexDirection: 'row', paddingVertical: 6, paddingHorizontal: 8, borderBottomWidth: 0.5, borderBottomColor: C.rule },
    tRowAlt: { flexDirection: 'row', paddingVertical: 6, paddingHorizontal: 8, borderBottomWidth: 0.5, borderBottomColor: C.rule, backgroundColor: C.lighter },
    ...
    chapterRow: { paddingVertical: 7, paddingHorizontal: 8, backgroundColor: '#EDEAE3', borderBottomWidth: 0.5, borderBottomColor: C.rule },
    chapterRowText: { fontSize: 8.5, fontFamily: 'Helvetica-Bold', color: C.ink, textTransform: 'uppercase', letterSpacing: 0.5 },
    unitRow: { paddingVertical: 5, paddingHorizontal: 8, backgroundColor: C.light, borderBottomWidth: 0.5, borderBottomColor: C.rule },
    unitRowText: { fontSize: 8, fontFamily: 'Helvetica-Bold', color: C.soft },
    subtotalRow: { flexDirection: 'row', paddingVertical: 5, paddingHorizontal: 8, backgroundColor: '#F0EEE8', borderBottomWidth: 0.5, borderBottomColor: C.rule },
    ...
    totalLine: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: C.rule },
    totalLineLabel: { fontSize: 8.5, color: C.soft },
    totalLineValue: { fontSize: 8.5, color: C.ink, fontFamily: 'Helvetica-Bold' },
    totalFinal: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 10, paddingHorizontal: 12, backgroundColor: C.headerBg, marginTop: 6 },
    ...
    // Signatures
    signatureIntro: { fontSize: 8.5, color: C.soft, lineHeight: 1.6, marginBottom: 22 },
    signaturesRow: { flexDirection: 'row', gap: 18 },
    signatureBox: { flex: 1, padding: 14, borderWidth: 0.5, borderColor: C.rule },
    signatureLabel: { fontSize: 6.5, fontFamily: 'Helvetica-Bold', color: C.meta, letterSpacing: 1.4, textTransform: 'uppercase', marginBottom: 8 },
    ...
    // Footer
    footer: { position: 'absolute', bottom: 24, left: 56, right: 56, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', borderTopWidth: 0.5, borderTopColor: C.rule, paddingTop: 8 },
    footerText: { fontSize: 6.5, color: C.meta, letterSpacing: 0.4 },
    footerRight: { fontSize: 6.5, color: C.meta },
  })

  // ── Sub-components (closures over rpdf primitives + styles) ──────────────
    ...
    return createElement(Page, { size: 'A4', style: s.page },
      ...
      createElement(View, { style: s.body },
        ...
        createElement(Clause, { number: 'Cláusula 5', title: 'Hitos de facturación y pago' },
          createElement(P, null, 'La facturación se realizará conforme a los hitos indicados en el Anexo II.'),
          createElement(P, null,
  ...
  function AnexoIPage(props: { data: FpeContractData; reference: string; projectName: string }) {
    ...
    type RenderUnit = { unit_nombre: string; line_items: { nombre: string; unidad_medida: string; cantidad: number; precio_unitario: number; total: number }[]; unit_total: number }
    ...
    if (data.chapters && data.chapters.length > 0) {
      renderChapters = data.chapters.map(ch => {
        const units = ch.units.map(u => ({
          ...
          unit_total:  u.total ?? u.line_items.reduce((sum, li) => sum + (li.total || 0), 0),
        }))
        return { chapter_nombre: ch.chapter_nombre, units, chapter_total: units.reduce((sum, u) => sum + u.unit_total, 0) }
      })
    } else {
      ...
      const units: RenderUnit[] = Array.from(grouped.entries()).map(([unit_nombre, items]) => ({
        unit_nombre,
        line_items: items.map(li => ({ nombre: li.nombre, unidad_medida: li.unidad, cantidad: li.cantidad, precio_unitario: li.precio_unitario, total: li.total })),
        unit_total: items.reduce((sum, li) => sum + (li.total || 0), 0),
      }))
      renderChapters = [{ chapter_nombre: 'Alcance adjudicado', units, chapter_total: units.reduce((sum, u) => sum + u.unit_total, 0) }]
    }
          ...
          createElement(View, { key: `ch-${ci}` },
            ...
            ...ch.units.flatMap((u, ui) => [
              ...
              ...u.line_items.map((li, li_i) =>
                createElement(View, { key: `li-${ci}-${ui}-${li_i}`, style: li_i % 2 === 0 ? s.tRow : s.tRowAlt, wrap: false },
  ...
  function AnexoIIPage(props: { data: FpeContractData; reference: string; projectName: string }) {
    ...
    return createElement(Page, { size: 'A4', style: s.page },
      ...
      createElement(View, { style: s.body },
        ...
        milestones.length === 0
          ? createElement(View, { style: { padding: 14, backgroundColor: C.light, borderLeftWidth: 2, borderLeftColor: C.warn } },
  ...
  function AnexoIIIPage(props: { data: FpeContractData; reference: string; projectName: string }) {
    ...
    const totalDays = phases.reduce((sum, p) => sum + (p.duracion_dias || 0), 0)
      ...
      createElement(View, { style: s.body },
        ...
        docs.length === 0
          ...
          : createElement(View, null,
              ...
              ...docs.map((d, i) =>
                createElement(View, { key: `d-${i}`, style: i % 2 === 0 ? s.tRow : s.tRowAlt, wrap: false },
      ...
      createElement(View, { style: s.body },
        ...
        createElement(View, { style: s.signaturesRow },
          ...
          createElement(View, { style: s.signatureBox, wrap: false },
            ...
            createElement(Text, { style: s.signatureName }, data.partner.contact_name || partnerLegalName),
            createElement(Text, { style: s.signatureRole }, `${data.partner.contact_role || 'Representante'} — ${partnerLegalName}`),
            createElement(View, { style: s.signatureSpace }),
            createElement(Text, { style: s.signatureNote }, 'Firma y fecha'),
            // DocuSign anchor (DO NOT rename — bound to lib/docusign/client.ts)
