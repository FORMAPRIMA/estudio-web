      ...
      >
          ...
          {loading ? (
            ...
            <>
              ...
              <div style={{ border: '1px solid #E8E6E0', borderRadius: 8, overflow: 'hidden', marginBottom: 16 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '30px 1fr 80px 130px 130px 70px', gap: 8, padding: '8px 12px', background: '#F8F7F4', fontSize: 10, fontWeight: 700, color: '#888', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                  <span>#</span>
                  <span>Nombre</span>
                ...
                {rows.length === 0 ? (
                  ...
                  <div key={i} style={{ display: 'grid', gridTemplateColumns: '30px 1fr 80px 130px 130px 70px', gap: 8, padding: '8px 12px', borderTop: '1px solid #F0EEE8', alignItems: 'center' }}>
                    ...
                    <select
                      ...
                      onChange={e => handleField(i, 'trigger_type', e.target.value as PlanRow['trigger_type'])}
                    ...
                    <span style={{ fontSize: 11, color: r.milestone_id ? '#1A1A1A' : '#CCC' }}>
                      {r.milestone_id ? '✓ ligado' : '—'}
                    </span>
        ...
        <div style={{ padding: '14px 24px', borderTop: '1px solid #E8E6E0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <button onClick={handleSave} disabled={saving || !sumOk} style={{ padding: '7px 16px', fontSize: 12, fontWeight: 600, background: sumOk ? '#1A1A1A' : '#CCC', color: '#fff', border: 'none', borderRadius: 5, cursor: sumOk ? 'pointer' : 'not-allowed', fontFamily: 'inherit' }}>
