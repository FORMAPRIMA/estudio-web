...
import { savePlantillaServicio, createServicio, deleteServicio } from '@/app/actions/plantillaPropuestas'
...
function ServicioEditor({
  ...
  function handleSave() {
    ...
    startSave(async () => {
      ...
      else { setSaveOk(true); onSaved(entry.id, { label, texto, entregables: grupos, semanas_default: semanas, pago }); setTimeout(() => setSaveOk(false), 2500) }
    })
  }
