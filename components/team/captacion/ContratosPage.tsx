          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#F8F7F4' }}>
                ...
                <th className="captacion-col-hide" style={{ padding: '10px 16px', fontSize: 9, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#AAA', textAlign: 'left', borderBottom: '1px solid #E8E6E0', whiteSpace: 'nowrap' }}>Honorarios (sin IVA)</th>
